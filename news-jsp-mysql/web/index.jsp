<%-- 
    Document   : index
    Created on : 19-Oct-2015, 22:44:57
    Author     : 24h
--%>
          ...
          <nav class="navbar navbar-inverse" role="navigation">      
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav main_nav">
                ...
                %>
                    <li><a href="<%= newsCategory.getUrlFriendly() %>"><%= newsCategory.getName() %></a></li>        
                <%
                    }
                %>
                ...
                <ul id="ticker01" class="news_sticker">
                    <%
                        ...
                        if(listNews != null) for(News news : listNews){
                            %> 
                            <li><a href="<%= request.getContextPath() %>/tin-tuc/<%= news.getUrlFriendly() %>.html"><img src="resources/img/news_thumbnail3.jpg" alt=""><%=news.getTitle()%></a></li> 
                            <%  
                        }
                    %>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
              ...
              <div class="slick_slider">
                <div class="single_iteam">
                  <a href="single_page.html"> <img src="resources/img/slider_img4.jpg" alt="img"></a>
                ...
                <div class="single_iteam">
                  <a href="single_page.html"> <img src="resources/img/slider_img2.jpg" alt="img"></a>
                  <div class="slider_article">
                    <h2><a class="slider_tittle" href="single_page.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                    <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
                  </div>
                ...
                <div class="single_iteam">
                  <a href="single_page.html"> <img src="resources/img/slider_img3.jpg" alt="img"></a>
                  <div class="slider_article">
                    <h2><a class="slider_tittle" href="single_page.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                    <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
                  </div>
                ...
                <div class="single_iteam">
                  <a href="single_page.html"> <img src="resources/img/slider_img1.jpg" alt="img"></a>
                  <div class="slider_article">
                    <h2><a class="slider_tittle" href="single_page.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                    <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
                  </div>
                             ...
                             <li>
                                <div class="media">
                                  ...
                                  <div class="media-body">
                                      <a href="<%= news.getUrlFriendly() %>.html" class="catg_title"> <%=news.getTitle() %></a>                        
                                  </div>
                                </div>
                             </li>
                            <%  
                      ...
                      <li>
                        <figure class="bsbig_fig">
                          <a href="single_page.html" class="featured_img">
                              <img alt="img" src="resources/img/featured_img1.jpg">
                    ...
                    <div class="single_post_content">
                      ...
                      <ul class="business_catgnav wow fadeInDown">
                        <li>
                          <figure class="bsbig_fig">
                            <a href="single_page.html" class="featured_img">
                                <img alt="img" src="resources/img/featured_img2.jpg">
                                <span class="overlay"></span>
                            </a>
                            <figcaption>
                              <a href="single_page.html">Proin rhoncus consequat nisl eu ornare mauris</a>
                      ...
                      <ul class="business_catgnav">
                        <li>
                          <figure class="bsbig_fig wow fadeInDown">
                            <a href="single_page.html" class="featured_img">
                                <img alt="img" src="resources/img/featured_img3.jpg">
                                <span class="overlay"></span>
                            </a>
                            <figcaption>
                              <a href="single_page.html">Proin rhoncus consequat nisl eu ornare mauris</a>
                  ...
                  <ul class="photograph_nav  wow fadeInDown">                
                    <li>
                      <div class="photo_grid">
                        ...
                        <a class="fancybox-buttons" data-fancybox-group="button" href="resources/img/photograph_img2.jpg" title="Photography Ttile 1">
                        <img src="resources/img/photograph_img2.jpg" alt="img06"/></a>  
                        </figure>
                      </div>
                    </li>
                    <li>
                      <div class="photo_grid">
                        <figure class="effect-layla">
                        <a class="fancybox-buttons" data-fancybox-group="button" href="resources/img/photograph_img3.jpg" title="Photography Ttile 2">
                          <img src="resources/img/photograph_img3.jpg" alt="img06"/>
                          </a>  
                        </figure>
                      </div>
                    </li>
                    <li>
                      <div class="photo_grid">
                        <figure class="effect-layla">
                        <a class="fancybox-buttons" data-fancybox-group="button" href="resources/img/photograph_img4.jpg" title="Photography Ttile 3">
                          <img src="resources/img/photograph_img4.jpg" alt="img06"/>
                          </a>                        
                        </figure>
                      </div>
                    </li>
                    <li>
                      <div class="photo_grid">
                        <figure class="effect-layla">
                           <a class="fancybox-buttons" data-fancybox-group="button" href="resources/img/photograph_img4.jpg" title="Photography Ttile 4">
                            <img src="resources/img/photograph_img4.jpg" alt="img06"/>
                          </a>                           
                        </figure>
                      </div>
                    ...
                    <li>
                      <div class="photo_grid">
                        <figure class="effect-layla">
                         <a class="fancybox-buttons" data-fancybox-group="button" href="resources/img/photograph_img2.jpg" title="Photography Ttile 5">
                            <img src="resources/img/photograph_img2.jpg" alt="img06"/>
                          </a>                          
                        </figure>
                      </div>
                    </li>
                    <li>
                      <div class="photo_grid">
                        <figure class="effect-layla">
                           <a class="fancybox-buttons" data-fancybox-group="button" href="resources/img/photograph_img3.jpg" title="Photography Ttile 6">
                            <img src="resources/img/photograph_img3.jpg" alt="img06"/>
                          </a>                           
                        </figure>
                      </div>
                      ...
                      <li>
                        <figure class="bsbig_fig  wow fadeInDown">
                          <a class="featured_img" href="single_page.html">
                              <img src="resources/img/featured_img1.jpg" alt="img">
                              <span class="overlay"></span>
                          </a>
                          <figcaption>
                            <a href="single_page.html">Proin rhoncus consequat nisl eu ornare mauris</a>
...
<!--                    <li>
                ...
                <div class="single_sidebar wow fadeInDown">
                  ...
                  <a class="sideAdd" href="#"><img src="resources/img/add_img.jpg" alt="img"></a>
                </div>
                <!-- End sponsor add -->
                 <!-- Category Archive -->
                <div class="single_sidebar wow fadeInDown">
